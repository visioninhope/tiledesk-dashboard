...
export class HomeCdsComponent implements OnInit, OnDestroy {
  ...
  getUserRole() {
    this.usersService.project_user_role_bs
      ...
      .subscribe((userRole) => {
        console.log('[HOME-CDS] - SUBSCRIPTION TO USER ROLE »»» ', userRole)
  ...
  getImageStorageThenBots() {
    if (this.appConfigService.getConfig().uploadEngine === 'firebase') {
      ...
      console.log('[HOME-CDS] - IMAGE STORAGE ', this.storageBucket, 'usecase firebase')
      ...
      console.log('[HOME-CDS] - IMAGE STORAGE ', this.baseUrl, 'usecase native')
  ...
  getProjectBots(storage, uploadEngineIsFirebase) {
    this.faqKbService.getFaqKbByProjectId().subscribe((faqKb: any) => {
      ...
      console.log('[HOME-CDS] - GET FAQKB RES (sorted)', faqKb);
      ...
      console.error('[HOME-CDS] - GET FAQKB - ERROR ', error);
